...
class DiscordGatewayTest {
    ...
    private val commandHandler = mock<DiscordSlashCommandHandler>()
    ...
    fun `routes command to command handler`() = runTest {
        ...
        whenever(commandHandler.handleCommand("/help", userId, chatId)).thenReturn("**Help**")

        val gateway = DiscordGateway(moatbot, client, commandHandler)
        ...
        verify(client).sendMessage(chatId, "**Help**")
